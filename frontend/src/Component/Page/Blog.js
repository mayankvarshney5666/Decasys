          ...
          <div className="row g-4 ratio_65">
              ...
              <div className="blog-box wow fadeInUp">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/1.jpg" className="bg-img blur-up lazyload" alt />
                  </a>
                </div>
            ...
            <div className="col-xxl-4 col-sm-6">
              <div className="blog-box wow fadeInUp" data-wow-delay="0.05s">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/2.jpg" className="bg-img" alt />
                  </a>
                </div>
                <div className="blog-contain">
                  <div className="blog-label">
            ...
            <div className="col-xxl-4 col-sm-6">
              <div className="blog-box wow fadeInUp" data-wow-delay="0.1s">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/3.jpg" className="bg-img blur-up lazyload" alt />
                  </a>
            ...
            <div className="col-xxl-4 col-sm-6">
              <div className="blog-box wow fadeInUp" data-wow-delay="0.15s">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/4.jpg" className="bg-img blur-up lazyload" alt />
                  </a>
                </div>
                <div className="blog-contain">
                  <div className="blog-label">
            ...
            <div className="col-xxl-4 col-sm-6">
              <div className="blog-box wow fadeInUp" data-wow-delay="0.2s">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/5.jpg" className="bg-img blur-up lazyload" alt />
                  </a>
                </div>
                <div className="blog-contain">
                  <div className="blog-label">
            ...
            <div className="col-xxl-4 col-sm-6">
              <div className="blog-box wow fadeInUp" data-wow-delay="0.3s">
                <div className="blog-image">
                  <a href="blog-detail.html">
                    <img src="images/inner-page/blog/2.jpg" className="bg-img blur-up lazyload" alt />
                  </a>
                </div>
                <div className="blog-contain">
                  <div className="blog-label">
                    ...
                    <div className="recent-post-box">
                      <div className="recent-box">
                        <a href="blog-detail.html" className="recent-image">
                          <img src="images/inner-page/blog/1.jpg" className="img-fluid blur-up lazyload" alt />
                        </a>
                      ...
                      <div className="recent-box">
                        <a href="blog-detail.html" className="recent-image">
                          <img src="images/inner-page/blog/2.jpg" className="img-fluid blur-up lazyload" alt />
                        </a>
                        <div className="recent-detail">
                          <a href="blog-detail.html">
                      ...
                      <div className="recent-box">
                        <a href="blog-detail.html" className="recent-image">
                          <img src="images/inner-page/blog/3.jpg" className="img-fluid blur-up lazyload" alt />
                        </a>
                        <div className="recent-detail">
                          <a href="blog-detail.html">
                      ...
                      <div className="recent-box">
                        <a href="blog-detail.html" className="recent-image">
                          <img src="images/inner-page/blog/4.jpg" className="img-fluid blur-up lazyload" alt />
                        </a>
                        <div className="recent-detail">
                          <a href="blog-detail.html">
                  ...
                  <div className="accordion-body">
                    <ul className="product-list product-list-2 border-0 p-0">
                      <li>
                        <div className="offer-product">
                          <a href="shop-left-sidebar.html" className="offer-image">
                            <img src="images/vegetable/product/23.png" className="blur-up lazyload" alt />
                          </a>
                      ...
                      <li>
                        <div className="offer-product">
                          <a href="shop-left-sidebar.html" className="offer-image">
                            <img src="images/vegetable/product/24.png" className="blur-up lazyload" alt />
                          </a>
                          <div className="offer-detail">
                            <div>
                              <a href="shop-left-sidebar.html">
                      ...
                      <li className="mb-0">
                        <div className="offer-product">
                          <a href="shop-left-sidebar.html" className="offer-image">
                            <img src="images/vegetable/product/26.png" className="blur-up lazyload" alt />
                          </a>
                          <div className="offer-detail">
                            <div>
                              <a href="shop-left-sidebar.html">
